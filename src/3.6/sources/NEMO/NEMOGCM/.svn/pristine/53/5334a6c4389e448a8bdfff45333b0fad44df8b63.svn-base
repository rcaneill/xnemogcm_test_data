...
MODULE agrif_types
  ...
  !       
  CHARACTER*100 parent_meshmask_file,elevation_database,parent_bathy_meter
  CHARACTER*100 elevation_name,parent_batmet_name
  CHARACTER*100 parent_coordinate_file,restart_file,updated_parent_file,restart_trc_file
