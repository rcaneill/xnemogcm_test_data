...
# for output of 5days for 1 year run
# nota: it is like std_main.sh but it calls routins for 5days
# -------------------------------------
#
# SYNOPSIS
# ========
#
# ``std_main_5D.sh -ts`` or ``std_main_5D.sh -plot`` 
# 
# DESCRIPTION
# ===========
#
...
# before calling std_main_5D.sh -plot 
#
# EXAMPLES
# ========
# $ ./std_main_5D.sh -plot -pdf 
#
# AUTHOR - date
# ===========
...
#
usage="Usage: std_main_5D.sh [OPTION]
Options
...
std_${PLOTTYPE}_all_last_year_5D, /postscript
EOF
    fi
    status_idl=${?}
    if [ ${status_idl} -ne 0 ]
