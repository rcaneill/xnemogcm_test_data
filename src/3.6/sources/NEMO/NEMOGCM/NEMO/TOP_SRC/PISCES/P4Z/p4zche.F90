MODULE p4zche
   ...
   PUBLIC   p4z_che_ahini    !
   PUBLIC   p4z_che_solve_hi !
...
#include "top_substitute.h90"
   ...
   !! $Id: p4zche.F90 7607 2017-01-25 15:37:31Z cetlod $ 
...
!CDIR NOVERRCHK
   ...
   SUBROUTINE p4z_che_ahini( p_hini )
      !!---------------------------------------------------------------------
      ...
      IF( nn_timing == 1 )  CALL timing_start('p4z_che_ahini')
      !
      DO jk = 1, jpk
        DO jj = 1, jpj
          DO ji = 1, jpi
      ...
      END DO
      !
      IF( nn_timing == 1 )  CALL timing_stop('p4z_che_ahini')
      !
   END SUBROUTINE p4z_che_ahini
   ...
   SUBROUTINE p4z_che_solve_hi( p_hini, zhi )
   ...
   IF( nn_timing == 1 )  CALL timing_start('p4z_che_solve_hi')
   ...
   IF( nn_timing == 1 )  CALL timing_stop('p4z_che_solve_hi')


   END SUBROUTINE p4z_che_solve_hi
