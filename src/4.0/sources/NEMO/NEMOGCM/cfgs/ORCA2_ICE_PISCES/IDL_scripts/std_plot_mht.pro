...
; compute meridional heat transport
    ...
    title = 'MHT (Black) & Atlantic MHT (Blue) '+std_file1_T+' !C (Red) '+std_file2_T
    plt1d, htr1, 'y', min = -2., max = 2., TITLE = title $
           , SMALL = [2, 2, 3], TICKLEN = 1, XGRIDSTYLE = 2 $
           , YTITLE = 'PW', YGRIDSTYLE = 2, /NOERASE, _extra = ex
    plt1d, htr2, 'y', COLOR = 250, /ov1d,  _extra = ex
    plt1d, htr1_atl, 'y', COLOR = 50, /ov1d,  _extra = ex
    plt1d, htr2_atl, 'y', COLOR = 250, /ov1d,  _extra = ex
