...
CONTAINS
  ...
  SUBROUTINE xios(set_reduce_axis_to_scalar_attr)  &
    ...
    IMPLICIT NONE
      TYPE(txios(reduce_axis_to_scalar))  :: reduce_axis_to_scalar_hdl
  ...
  END SUBROUTINE xios(set_reduce_axis_to_scalar_attr)

  SUBROUTINE xios(set_reduce_axis_to_scalar_attr_hdl)  &
    ( reduce_axis_to_scalar_hdl, operation )

    IMPLICIT NONE
      TYPE(txios(reduce_axis_to_scalar)) , INTENT(IN) :: reduce_axis_to_scalar_hdl
      CHARACTER(len = *) , OPTIONAL, INTENT(IN) :: operation

      CALL xios(set_reduce_axis_to_scalar_attr_hdl_)  &
      ( reduce_axis_to_scalar_hdl, operation )

  END SUBROUTINE xios(set_reduce_axis_to_scalar_attr_hdl)

  SUBROUTINE xios(set_reduce_axis_to_scalar_attr_hdl_)   &
  ...
  SUBROUTINE xios(get_reduce_axis_to_scalar_attr)  &
    ( reduce_axis_to_scalar_id, operation )
  ...
  END SUBROUTINE xios(get_reduce_axis_to_scalar_attr)

  SUBROUTINE xios(get_reduce_axis_to_scalar_attr_hdl)  &
    ( reduce_axis_to_scalar_hdl, operation )
  ...
  END SUBROUTINE xios(get_reduce_axis_to_scalar_attr_hdl)

  SUBROUTINE xios(get_reduce_axis_to_scalar_attr_hdl_)   &
    ( reduce_axis_to_scalar_hdl, operation_ )
  ...
  SUBROUTINE xios(is_defined_reduce_axis_to_scalar_attr)  &
    ( reduce_axis_to_scalar_id, operation )
  ...
  END SUBROUTINE xios(is_defined_reduce_axis_to_scalar_attr)

  SUBROUTINE xios(is_defined_reduce_axis_to_scalar_attr_hdl)  &
    ( reduce_axis_to_scalar_hdl, operation )
  ...
  END SUBROUTINE xios(is_defined_reduce_axis_to_scalar_attr_hdl)

  SUBROUTINE xios(is_defined_reduce_axis_to_scalar_attr_hdl_)   &
    ( reduce_axis_to_scalar_hdl, operation_ )
  ...
  END SUBROUTINE xios(is_defined_reduce_axis_to_scalar_attr_hdl_)
